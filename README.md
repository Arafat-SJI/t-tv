...
[![GitHub](https://img.shields.io/github/stars/devSahinur/TowerTV?style=social)](https://github.com/devSahinur/TowerTV)
[![Live Demo](https://img.shields.io/badge/Live-TowerTV.vercel.app-ff8c1a?logo=vercel)](https://TowerTV.vercel.app)

**[🔴 Live Demo → TowerTV.vercel.app](https://TowerTV.vercel.app)**
...
> Visit the live app to see TowerTV in action.
...
git clone https://github.com/devSahinur/TowerTV.git
cd TowerTV
...
The easiest way to deploy TowerTV:
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/devSahinur/TowerTV)

## 📡 Data Source

TowerTV uses the public APIs provided by [iptv-org](https://github.com/iptv-org/iptv):
...
TowerTV does not host or provide any video content. It aggregates publicly available IPTV streams indexed by the [iptv-org](https://github.com/iptv-org/iptv) project. All streams are provided by third parties and may be subject to their respective terms of service.
...
[GitHub](https://github.com/devSahinur/TowerTV) · [Live Demo](https://TowerTV.vercel.app) · [Report Bug](https://github.com/devSahinur/TowerTV/issues)
