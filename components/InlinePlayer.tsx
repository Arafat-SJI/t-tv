...
export function InlinePlayer() {
  ...
  if (!currentChannel) {
    return (
      <div className="relative rounded-lg sm:rounded-xl overflow-hidden bg-gradient-to-br from-brand/5 via-secondary/30 to-background">
        <div className="aspect-video flex items-center justify-center">
          <div className="flex flex-col items-center gap-2 sm:gap-3 text-center px-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-brand/10 flex items-center justify-center animate-pulse">
              <Tv className="h-5 w-5 sm:h-6 sm:w-6 text-brand" />
            </div>
            <div>
  ...
  return (
    <div className="rounded-lg sm:rounded-xl overflow-hidden border-0 bg-transparent shadow-none">
      ...
      <div className="flex flex-col md:flex-row">
          ...
          <AnimatePresence>
            {isLoading && (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[#1a0800]/90 to-black/90"
              >
                <div className="flex flex-col items-center gap-2 sm:gap-3">
                  <div className="relative">
                    <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-full border-[3px] border-brand/20 border-t-brand animate-spin" />
                    <Tv className="absolute inset-0 m-auto h-4 w-4 sm:h-6 sm:w-6 text-brand" />
                  </div>
            ...
            {isPaused && !isLoading && !hasError && (
              <div className="absolute inset-0 flex items-center justify-center pointer-events-auto">
                <motion.button
                  ...
                  onClick={togglePlayPause}
                  className="w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-brand/90 flex items-center justify-center shadow-brand-lg hover:bg-brand active:scale-95 transition-all"
                >
        ...
        <div className="flex-1 p-3 sm:p-3.5 md:p-4 flex flex-col min-w-0 overflow-hidden">
          ...
          <div className="flex items-start gap-3">
            <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-brand/20 to-secondary overflow-hidden flex items-center justify-center shrink-0 border border-brand/20">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={
                  currentChannel.logo ||
          ...
          <div className="mt-3 md:mt-4 space-y-2 md:space-y-2.5 text-[11px] sm:text-xs text-muted-foreground flex-1 overflow-y-auto">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              {currentChannel.countryInfo && (
                <span className="flex items-center gap-1.5">
                  <Globe className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand/70 shrink-0" />
                  {currentChannel.countryInfo.flag} {currentChannel.countryInfo.name}
                </span>
              )}
              <span className="flex items-center gap-1.5">
                <Eye className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand/70 shrink-0" />
            ...
            {currentChannel.network && (
              <div className="flex items-center gap-1.5">
                <Building2 className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand/70 shrink-0" />
            ...
            {currentChannel.owners?.length > 0 && (
              <div className="flex items-center gap-1.5">
                <Users className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand/70 shrink-0" />
            ...
            {currentChannel.languages?.length > 0 && (
              <div className="flex items-center gap-1.5">
                <LanguagesIcon className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand/70 shrink-0" />
            ...
            {currentChannel.launched && (
              <div className="flex items-center gap-1.5">
                <Calendar className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand/70 shrink-0" />
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <span className="flex items-center gap-1.5">
                <Signal className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand/70 shrink-0" />
            ...
            {currentChannel.website && (
              <div className="flex items-center gap-1.5 pt-0.5">
                <ExternalLink className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand/70 shrink-0" />
                <a
